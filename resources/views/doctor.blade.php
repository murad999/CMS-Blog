                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="subpage-banner-text">
                                <h4 class="subpage-head">OUR DOCTORS</h4>
                                <h5><a href="{{route('index')}}">HOME</a> <i class="icofont icofont-double-right"></i> <a href="{{route('doctor')}}">DOCTORS</a></h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="item text-center">
                        <div class="item-holder">
                            <div class="awsm-grid-holder">
                                <img src="{{$doctor->featured}}" alt="{{$doctor->name}}" class="img-responsive" />                                    <div class="item-data-holder">
                                    <div class="awsm-personal-info">
                                        <h4 class="doctor-name">{{$doctor->name}}</h4>
                                        <p>{{ $doctor->designation}}<span class="depart">Department of {{$doctor['department']->title}}</span></p>
                                    </div>
                                    <!-- .awsm-personal-info -->

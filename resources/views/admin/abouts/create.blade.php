...
@section('content')
	...
	<div class="panel panel-default">
         <div class="panel-heading">Create a About
			     <div class="text-right">
               <a  class="btn btn-success " href="{{route('abouts')}}">Back To About </a> 
            </div>
         </div>

        <div class="panel-body">
        	<form action="{{route('abouts.store')}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
        		{{csrf_field()}}
	            ...
	            <img class="thumbnail preview" src="" width="100px">
	            <div class="form-group">

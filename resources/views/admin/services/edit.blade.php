        ...
        <div class="panel-body">
        	<form action="{{route('services.update',['id'=>$service->id])}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	        	...
	        	<div class="form-group">
	            	...
	            	<input name="title" class="form-control" type="text" value="{{$service->title}}"></input>
	            </div>
	            
	            <div class="form-group">
	            	<label for="description">Content</label>
	            	<textarea name="description" id="editor" cols="5" rows="5" class="form-control">{{$service->description}}</textarea>
	            </div>
              <div class="form-group">
                <label for="icon">Icon</label>
                <input name="icon" class="form-control" type="text" value="{{$service->icon}}"></input>
              </div>
	            <div class="form-group">

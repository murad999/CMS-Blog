	...
	<div class="panel panel-default">
         <div class="panel-heading">Create a New Post
			<div class="text-right">
               <a  class="btn btn-success " href="{{route('depServices')}}">Back to Department Service </a> 
            </div>
         </div>

        <div class="panel-body">
        	<form action="{{route('depServices.store')}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
        		{{csrf_field()}}
